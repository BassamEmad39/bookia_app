...
class SharedPref {
  ...
  static Future<void> setUserInfo(User user) async {
    ...
    String jsonToString = jsonEncode(modelToJson);
    setString(kUserInfo, jsonToString);
  }

  static User getUserInfo() {
    var cachedserString = getString(kUserInfo);
    var stringToJson = json.decode(cachedserString);
